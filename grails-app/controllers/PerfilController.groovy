...
class PerfilController {
	...
	def list = {
		...
		[authorityList: Perfil.list(params)]
	}
	 ...
	 */
	def show = {
		def authority = Perfil.get(params.id)
		if (!authority) {
			flash.message = "Perfil not found with id $params.id"
	...
	def delete = {
		...
		flash.message = "Perfil $params.id deleted."
		redirect action: list
	}
